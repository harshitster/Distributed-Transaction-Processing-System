...
const (
	CoordinatorService_Submit_FullMethodName = "/coordinator.CoordinatorService/Submit"
)
...
type CoordinatorServiceClient interface {
	Submit(ctx context.Context, in *TxnRequest, opts ...grpc.CallOption) (*TxnResponse, error)
}
...
func (c *coordinatorServiceClient) Submit(ctx context.Context, in *TxnRequest, opts ...grpc.CallOption) (*TxnResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TxnResponse)
	err := c.cc.Invoke(ctx, CoordinatorService_Submit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoordinatorServiceServer interface {
	Submit(context.Context, *TxnRequest) (*TxnResponse, error)
...
func (UnimplementedCoordinatorServiceServer) Submit(context.Context, *TxnRequest) (*TxnResponse, error) {
...
func _CoordinatorService_Submit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TxnRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoordinatorServiceServer).Submit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoordinatorService_Submit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoordinatorServiceServer).Submit(ctx, req.(*TxnRequest))
	}
...
var CoordinatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Submit",
			Handler:    _CoordinatorService_Submit_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "src/coordinator/proto/txn.proto",
}
